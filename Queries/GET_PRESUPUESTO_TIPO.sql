create or replace PROCEDURE GET_PRESUPUESTO_TIPO (VAR_presupuesto_tipo IN NUMBER,CUR_RPTA OUT sys_refcursor)IS
BEGIN
    ...
    WHERE A.id_presupuesto_tipo=VAR_presupuesto_tipo
